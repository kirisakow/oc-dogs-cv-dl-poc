...
- [x] Transfer learning (le réentraînement) depuis le modèle YOLO26 en cls de tailles nano, small et medium.
  ...
  - [x] d'abord sur 3 classes,
  - [x] ensuite sur 120 classes.
- [x] Ajouter interprétabilité avec GradCAM ou EigenCAM. [Exemple][3].
...
- [ ] Inclure la sélection de données en entrée du moteur de prédiction (par exemple, liste déroulante ou saisie de champs).
...
💡 Seulement afficher les perf du modèle SoTA, pas du modèle *baseline*.
